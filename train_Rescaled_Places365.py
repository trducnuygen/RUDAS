...
parser.add_argument('-r', '--data', type=str, default='./Places365_Rescaled_Subsets', help='path to dataset')
...
#        'efficientnetv2', # variant s
    ...
    path_temp = args.data # 'path/to/Rescaled_Places365'
    for name_model in arr_models:        
        args.arch = name_model
        arr_rescaled_set = arr_rescaled_set = ["r0.1", "r0.2", "r0.3", "r0.4", "r0.5"]
        for rescaled_set in arr_rescaled_set:
            # get name of dataset
            model_name_dataset = args.arch + '_' + 'Age_places365_' + str(rescaled_set)
            ...
            model = gM.get_model(model_name_dataset,num_class=365) # Places365 has 365 classes
